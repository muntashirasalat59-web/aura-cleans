-- =============================================
-- Purchases: GST fields + create_purchase RPC
-- Run in Supabase SQL Editor after supabase.functions.sql
-- =============================================
...
-- Backfill older rows (taxable amount was stored as total_amount)
UPDATE public.purchases
SET
  subtotal = total_amount,
  gst_amount = 0,
  gst_percent = 18
WHERE subtotal = 0 AND gst_amount = 0 AND total_amount > 0;
